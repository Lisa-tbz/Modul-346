...
![instancedetails](images/instance-details.jpg)
...
```powershell
...
"InstanceId": "i-04854a406bd7bcefc",
...
...
```
#### aws ec2 stop-instances --instance-ids i-04854a406bd7bcefc
```powershell
{
"StoppingInstances": [
"InstanceId": "i-04854a406bd7bcefc",
...
```
#### aws ec2 start-instances --instance-ids i-04854a406bd7bcefc
```powershell
...
### Terraform Commands
#### Initialisierung
![init.png](images/init.jpg)

#### Änderungen planen
![plan.png](images/plan.jpg)

#### Änderungen durchführen
![apply1.png](images/apply.jpg)
![apply2.png](images/apply2.jpg)

### Telnet
![telnet2.png](images/telnet1.jpg)
